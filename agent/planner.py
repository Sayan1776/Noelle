    ...
    messages = [
        {
            ...
            "content": (
                ...
                "- data_agent: analyze datasets, CSV files, tables, statistics\n"
                "- browse: open a website, search the web, or interact with a web page\n\n"
                "Rules:\n"
                "1. Steps must describe WHAT to do, not HOW.\n"
                "2. Do NOT mention tool names, APIs, functions, or parameters.\n"
                "3. Do NOT include words like file_qa, coding, browse, function, call, or tool.\n"
